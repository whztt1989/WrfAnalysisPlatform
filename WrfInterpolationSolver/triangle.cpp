...
void triangulate(char *triswitches, struct triangulateio *in,
                 struct triangulateio *out, struct triangulateio *triangle_vorout)
#else /* not ANSI_DECLARATORS */
void triangulate(triswitches, in, out, triangle_vorout)
char *triswitches;
struct triangulateio *in;
struct triangulateio *out;
struct triangulateio *triangle_vorout;
#endif /* not ANSI_DECLARATORS */
...

{
  ...
  if (triangle_vorout != (struct triangulateio *) NULL) {
    triangle_vorout->numberofpoints = m.triangles.items;
    triangle_vorout->numberofpointattributes = m.nextras;
    triangle_vorout->numberofedges = m.edges;
  }
#endif /* TRILIBRARY */
  ...
  if (b.voronoi) {
#ifdef TRILIBRARY
    writevoronoi(&m, &b, &triangle_vorout->pointlist, &triangle_vorout->pointattributelist,
                 &triangle_vorout->pointmarkerlist, &triangle_vorout->edgelist,
                 &triangle_vorout->edgemarkerlist, &triangle_vorout->normlist);
#else /* not TRILIBRARY */
