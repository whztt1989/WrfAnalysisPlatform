#ifndef WRF_SEARCHING_PREPROCESSING_PARA_WIDGET_H_
#define WRF_SEARCHING_PREPROCESSING_PARA_WIDGET_H_
...
class WrfSearchingPreProcessingParaWidget : public QDialog
{
    Q_OBJECT

public:
    WrfSearchingPreProcessingParaWidget();
    ~WrfSearchingPreProcessingParaWidget();

    void GetParameters(int& year_length, int& day_length, int& grid_size, int& analog_num,
